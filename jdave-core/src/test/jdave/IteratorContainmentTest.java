 ...
 * @author Joni Freeman
 */
public class IteratorContainmentTest extends TestCase {
    private IteratorContainment containment;

    @Override
    protected void setUp() throws Exception {
        containment = new IteratorContainment(Arrays.asList(1, 2, 3).iterator());
    }
